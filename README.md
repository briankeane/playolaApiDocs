# playola OpenAPI Specification
[![Build Status](https://travis-ci.org/lonesomewhistle/playolafrontend.svg?branch=master)](https://travis-ci.org/lonesomewhistle/playolafrontend)
...
6. If you did everything correct, https://lonesomewhistle.github.io/playolafrontend/ will lead to your new docs
...
- Documentation(ReDoc): https://lonesomewhistle.github.io/playolafrontend/
- SwaggerUI: https://lonesomewhistle.github.io/playolafrontend/swagger-ui/
- Look full spec:
    + JSON https://lonesomewhistle.github.io/playolafrontend/swagger.json
    + YAML https://lonesomewhistle.github.io/playolafrontend/swagger.yaml
- Preview spec version for branch `[branch]`: https://lonesomewhistle.github.io/playolafrontend/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://lonesomewhistle.github.io/playolafrontend/ with url from the message: `Server started <url>`
